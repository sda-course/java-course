...
public class Exercises3 {
    public static void main(String[] args) {
        ...
        4. Wykonaj ćwiczenie 3 dla liczb dzisiętnych
        ...
        6. Oblicz ile należy zapłacić za parkowanie trwające 3 godziny i 45 minut, jeśli pierwsza godzina kosztuje 2 zł,
           każda następna 3 zł, a naliczenie pełnej godziny nastepuje po przekroczeniu 30 minut
           UWAGA!!!
           Zapisz wyrażenie tak, aby po zmianie czasu trwania parkowania obliczyło ono nową, poprawną wartość
         */
    }
}
