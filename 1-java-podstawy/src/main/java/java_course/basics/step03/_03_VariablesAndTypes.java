 ...
 */
public class _03_VariablesAndTypes {
    public static void main(String[] args) {
        ...
        */
        ...
        //np. 0.1 czyli 1/10 nie da się zapisać bez zokrąglenie w kodzie dwójkowym bo nie ma takiego ułamka, który miałby w mianowniku
