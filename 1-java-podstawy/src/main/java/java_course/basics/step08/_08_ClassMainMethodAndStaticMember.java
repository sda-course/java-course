 ...
 */
public class _08_ClassMainMethodAndStaticMember {
    /**
    ...
    public static void main(String[] args) {
        ...
        _08_ClassMainMethodAndStaticMember.printMenu();
        //pełne odwołanie do pola statycznego, wewnątrz klasy wystarczy COUNTER
        System.out.println("Pole statyczne COUNTER " + _08_ClassMainMethodAndStaticMember.COUNTER);


        //Klasa z metodą main, jest zwykła klasą, więc można tworzyć obiekty tej klasy
        System.out.println("Tworzymy instancję klasy");
        _08_ClassMainMethodAndStaticMember app = new _08_ClassMainMethodAndStaticMember();
