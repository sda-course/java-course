 ...
 */
public class _06_WhileInstruction {
    public static void main(String[] args) {
        ...
        while(scanner.nextInt() != 5){
            System.out.println("Wpisz liczbę 5!");
        }
        ...
        while(true){
            ...
            if (localCounter == 5){
                ...
                System.out.println("Wykonuję zagnieżdżoną instrukcję while!");
                System.out.print("\033[0m");
                while (localCounter-- > 0 ){
                    System.out.print("#");
                }
                System.out.println("\n\u001B[43m"+"Wpisz 5 aby zakończyć pętlę zewnętrzną!"+"\033[0m");
            }
        }
    }
}
